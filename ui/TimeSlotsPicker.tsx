    ...
    <View testID="test-time-slots">
      <View className="pb-safe-offset-10 border-2 border-gray-400 rounded-md p-2 m-2">
        ...
        <View className="flex-row justify-between px-2">
          ...
          <Button onPress={() => onTimeSlotCancelled()} className="bg-slate-500 w-12 h-10 text-center items-center" testID="test-time-picker-close-button"> X</Button>
        </View>
